...
public class Main {
    ...
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        ArrayList<posttest5.Penyewa> dataPenyewa = new ArrayList<>();
        ArrayList<posttest5.Petugas> dataPetugas = new ArrayList<>();
        int pilihan;
        ...
        while (true) {
            ...
            switch (menu) {
                case 1 -> {
                    ...
                    dataPenyewa.add(new posttest5.Penyewa (No,Nama_DVD,Nama_penyewa,No_Telp,harga,tanggal));
                    } else {
                        System.out.println("==> Masukkan Data <==");
                    System.out.print("Masukkan Nomor : ");
                    int No = Integer.parseInt(input.readLine());
                    ...
                    System.out.print("Masukkan Harga Sewa : ");
                    int harga = Integer.parseInt(input.readLine());
                    dataPetugas.add(new posttest5.Petugas(No, Kode_Petugas,Nama_DVD,Nama,harga));
                    }
                }
                case 2 -> {
...
//                        System.out.println("DVD ke-" + (i + 1));
                ...
                case 3 -> {
                    ...
                    for (posttest5.Penyewa pnyw : dataPenyewa) {
                        ...
                        System.out.println("Masukkan Nama DVD yang ingin di update : ");
                    String nomor = input.readLine();
                    for (posttest5.Petugas ptgs : dataPetugas) {
